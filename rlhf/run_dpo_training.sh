...
python qlora_dpo.py --dataset="ErebusTN/EGen-Dataset" `# rlhf dataset` \
    --dataset_format="gpt" `# follow gpt format` \
    ...
    --model_name_or_path "lyogavin/EGen33B-merged" `# the base model to train on` \
    --reference_model "lyogavin/EGen33B-merged" `# the reference model the training should reference` \
